...
void tagtinker_scene_main_menu_on_enter(void* ctx) {
    ...
    submenu_set_header(app->submenu, TAGTINKER_DISPLAY_NAME " " TAGTINKER_VERSION);
    ...
    submenu_add_item(app->submenu, "? Help (Broadcast)", MainMenuHelpBroadcast, main_menu_cb, app);
