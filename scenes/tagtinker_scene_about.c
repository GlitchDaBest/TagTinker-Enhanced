...
static void about_draw_cb(Canvas* canvas, void* _model) {
    ...
    if(model->mode == 1U) {
        ...
        canvas_draw_str_aligned(canvas, 64, 8, AlignCenter, AlignTop, TAGTINKER_DISPLAY_NAME);
        canvas_draw_str_aligned(canvas, 64, 18, AlignCenter, AlignTop, TAGTINKER_VERSION);
        canvas_draw_str_aligned(canvas, 64, 28, AlignCenter, AlignTop, "App by I12BP8");
        canvas_draw_str_aligned(canvas, 64, 38, AlignCenter, AlignTop, "Enh. GlitchDaBest");
        canvas_draw_str_aligned(canvas, 64, 48, AlignCenter, AlignTop, "furrtek · 7h30th3r0n3");
    }
}
